...
function get_etichette(up_name,type){
	...
	$.ajax({
		dataType:"json",
		url:"http://10.10.10.196:8080/JeerpDa/confort/indicators/"+type+"_"+up_name+"/options",
		type: "GET",
...
function do_gauge(up_name,type,opts,gauge){
	...
	$.ajax({
		dataType:"json",
		url:"http://10.10.10.196:8080/JeerpDa/confort/indicators/"+type+"_"+up_name+"",
		type: "GET",
		success:function(data){
			if(typeof data.result=="undefined"){
				console.log("TIPO "+data.result);
				d_result=-3;
		...
		complete: function(){
			console.log("GAUGE RESULT: "+ d_result);
			gauge.set(d_result);
		},
		error: function(x, t, r){
			console.log(x.response.message); 
